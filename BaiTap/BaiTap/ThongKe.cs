    ...
    public partial class ThongKe : Form
    {
        ...
        public void LoadFormcustom()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select name," +
                ...
                "where oi.CreateDated >='2022-12-07' and ei.CreatedDate <='2022-12-14'", con);
        ...
        //    model.CreatedDate = datetimpiceNgayBatDau.Value;
        //    return model;
        //}
        ...
        private void dgvPhieuXuat_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    {
            //        datetimpiceNgayBatDau.Value = Convert.ToDateTime(ConvertDateTime(dgvPhieuXuat.Rows[cell.RowIndex].Cells["tdNgayXuat"].Value.ToString()));
            //    }
